...
import { dict as wifiPages } from "./i18n-pages-wifi";
...
const dict: Record<Lang, Record<string, string>> = {
  id: {
    ...
    "err.retry": "Coba lagi",
    "pwa.update": "Versi baru tersedia!",
    "pwa.hint": "Klik untuk memuat ulang ke versi terbaru.",
  ...
  en: {
    ...
    "pwa.hint": "Click to reload to the latest version.",
    "pwa.reload": "Reload",
    "role.owner": "owner",
    "role.admin": "admin",
    "role.member": "member",
...
for (const mod of [serverPages, sshPages, backupPages, miscPages, healthPages, secPages, sshcmdPages, reportPages, approvalsPages, sshhealthPages, panelbackupPages, wifiPages]) {
