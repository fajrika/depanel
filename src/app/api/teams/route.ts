  ...
  const data = memberships
    .map((m) => ({
      ...
      members: m.team.members.map((x) => ({
        ...
        canViewCost: x.role !== "member" || x.canViewCost,
        canViewReports: x.role !== "member" || x.canViewReports,
        canSchedule: x.role !== "member" || x.canSchedule,
        canBackup: x.role !== "member" || x.canBackup,
        canBackupDb: x.role !== "member" || x.canBackupDb,
        canSsh: x.role !== "member" || x.canSsh,
        canInfra: x.role !== "member" || x.canInfra,
        canAccounts: x.role !== "member" || x.canAccounts,
        canNotify: x.role !== "member" || x.canNotify,
        canFirewall: x.role !== "member" || x.canFirewall,
        canConsole: x.role !== "member" || x.canConsole,
        canManage: x.role !== "member" || x.canManage,
